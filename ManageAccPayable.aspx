<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageAccPayable.aspx.cs" Inherits="ManageAccPayable" %>
...
<body>
    ...
    <div id="container" align="center">
        ...
        <div id="form" align="left">
            ...
            <asp:TextBox ID="txtAccPayID" runat="server" Visible="false"></asp:TextBox>
            ...
            <table id="tblForm">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtAmount" runat="server"></asp:TextBox>Please insert the amount you wish to pay.
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtAccPayDate" runat="server"></asp:TextBox>
                        <cc1:CalendarExtender ID="txtAccPayDate_CalendarExtender" runat="server" 
                            TargetControlID="txtAccPayDate">
                ...
                <Columns>			                                                           										
                        ...
                        <HeaderStyle Font-Size="XX-Small" Font-Names="Verdana" Font-Bold="True" HorizontalAlign="Center"
				            ...
				            <ItemTemplate>							
                                <asp:Panel ID="pnlPAmountP" runat="server">
					                <asp:Label Runat="server" ID="lblPAmountP" Text='<%# DataBinder.Eval(Container.DataItem, "AmountPay") %>'></asp:Label>
                                </asp:Panel>	
                            </ItemTemplate>                                                    
                    </asp:TemplateColumn>
					...
					<asp:TemplateColumn HeaderText="Edit">
						...
						<asp:Panel ID="pnlPEdit" runat="server">
							<asp:HyperLink id="PLinkButton1" runat="server" NavigateUrl='<%# EditAccPay(DataBinder.Eval(Container.DataItem, "ID").ToString()) %>'>Edit Item</asp:HyperLink>
						</asp:Panel>
						</ItemTemplate>
					</asp:TemplateColumn>
